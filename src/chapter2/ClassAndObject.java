...
class TriangleMath{
	...
	double getCircumference(double bottom, double height, double hypotenuse) {
	...
	double getSign(double hypotenuse, double height) {
...
public class ClassAndObject {
	...
	public static void main(String[] args) {
		...
		Korean korea1 = new Korean();
		Korean korea2 = new Korean();
		...
		System.out.println(korea1.nationality);
		System.out.println(korea2.nationality);
		
		korea1.nationality = "한국";

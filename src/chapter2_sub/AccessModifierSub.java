...
// 접근 제어자 public 이기 때문에 외부 패키지에서 import가 가능
import chapter2.AccessModifier;

//chapter2 package에 선언된 accessmodifierruns 클래스는
// 접근 제어자가 default(package) 이기 때문에 외부 패키지에서 Import 가 불가능
...
public class AccessModifierSub {
	...
	void method() {
		...
		// 접근제어자 public이기 때문에 외부 패키지에서 접근이 가능
		instance.publicVariable = 0;
		
		// AccessModifier의 protectedVariable, defaultVariable, privateVariable 필드
...
//		instance.privateVariable = 0;
		...
		// AccessModifier의 defaultVariable, privateVariable필드는
